...
)
{
    ...
    popUp.addComponent(new GLTFShape('models/doorbell icon.glb'))
    popUp.setParent(entity)
    popUp.addComponent(new Transform())
    popUp.addComponent(new utils.KeepRotatingComponent(Quaternion.Euler(0, 45, 0)))
    ...
    button.addComponent(new GLTFShape('models/doorbell.glb'))
